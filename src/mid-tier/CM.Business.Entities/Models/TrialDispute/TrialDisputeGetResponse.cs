...
public class TrialDisputeGetResponse : CommonResponse
{
    ...
    [JsonProperty("trial_participants")]
    public List<TrialParticipantGetResponse> TrialParticipants { get; set; }

    [JsonProperty("trial_interventions")]
    public List<TrialInterventionGetResponse> TrialInterventions { get; set; }

    [JsonProperty("trial_outcomes")]
    public List<TrialOutcomeGetResponse> TrialOutcomes { get; set; }
}