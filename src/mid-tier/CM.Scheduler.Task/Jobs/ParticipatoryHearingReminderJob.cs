...
public class ParticipatoryHearingReminderJob : JobBase
{
    private const string Identity = "participatory-hearing-reminder-job";

    public ParticipatoryHearingReminderJob(IServiceScopeFactory serviceScopeFactory)
    {
    ...
    public override async System.Threading.Tasks.Task Execute(IJobExecutionContext context)
    {
        try
        {
            ...
            await service.RunParticipatoryHearingReminderNotifications();
            context.Result = true;
