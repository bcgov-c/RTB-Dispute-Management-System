...
namespace CM.Scheduler.Task.Jobs
{
    ...
    public class MhvAppLinkedFinalScheduleJob : JobBase
    {
        private const string Identity = "Mhv-App-Linked-Final-Schedule-Job";

        public MhvAppLinkedFinalScheduleJob(IServiceScopeFactory serviceScopeFactory)
        {
        ...
        public override async System.Threading.Tasks.Task Execute(IJobExecutionContext context)
        {
            try
            {
                ...
                await service.RunMhvAppLinkedFinalReminder();
                context.Result = true;
