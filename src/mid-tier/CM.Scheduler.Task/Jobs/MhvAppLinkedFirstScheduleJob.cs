...
namespace CM.Scheduler.Task.Jobs
{
    ...
    public class MhvAppLinkedFirstScheduleJob : JobBase
    {
        private const string Identity = "Mhv-App-Linked-First-Schedule-Job";

        public MhvAppLinkedFirstScheduleJob(IServiceScopeFactory serviceScopeFactory)
        {
        ...
        public override async System.Threading.Tasks.Task Execute(IJobExecutionContext context)
        {
            try
            {
                ...
                await service.RunMhvAppLinkedFirstReminder();
                context.Result = true;
