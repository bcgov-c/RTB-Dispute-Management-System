...
namespace CM.Scheduler.Task.Jobs
{
    ...
    public class MhvAppCnFirstScheduleJob : JobBase
    {
        private const string Identity = "Mhv-App-Cn-First-Schedule-Job";

        public MhvAppCnFirstScheduleJob(IServiceScopeFactory serviceScopeFactory)
        {
        ...
        public override async System.Threading.Tasks.Task Execute(IJobExecutionContext context)
        {
            try
            {
                ...
                await service.RunMhvAppCnFirstReminder();
                context.Result = true;
