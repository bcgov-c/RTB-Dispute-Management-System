...
using CM.Services.ReconciliationReportSender.ReconciliationReportSenderService.IntegrationEvents.EventHandling;
...
public static class CustomExtensionMethods
{
    ...
    public static IServiceCollection AddCustomIntegrations(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddTransient<ReconciliationReportSenderEventHandler, ReconciliationReportSenderEventHandler>();
