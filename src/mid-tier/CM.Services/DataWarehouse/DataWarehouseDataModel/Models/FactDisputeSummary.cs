...
public class FactDisputeSummary
{
    ...
    public DisputeSubType DisputeSubType { get; set; }

    public DisputeCreationMethod? CreationMethod { get; set; }

    public MigrationSourceOfTruth? MigrationSourceOfTruth { get; set; }

    public DisputeUrgency? DisputeUrgency { get; set; }

    public DisputeStage? LastStage { get; set; }

    public DisputeStatuses LastStatus { get; set; }

    public DisputeProcess? LastProcess { get; set; }
