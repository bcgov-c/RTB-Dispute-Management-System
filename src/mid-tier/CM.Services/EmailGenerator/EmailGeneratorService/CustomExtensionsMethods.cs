...
using CM.Services.EmailGenerator.EmailGeneratorService.IntegrationEvents.EventHandling;
...
public static class CustomExtensionsMethods
{
    ...
    public static IServiceCollection AddCustomIntegrations(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddTransient<EmailGenerateIntegrationEventHandler, EmailGenerateIntegrationEventHandler>();
