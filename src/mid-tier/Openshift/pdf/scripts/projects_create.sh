BuildTemplate=pdf-generator-build-configuration.yaml
DeploymentTemplate=pdf-generator-deploy-configuration.yaml

BuildConfiguration=latestBuild/pdf-generator-build-configuration.json
DeploymentConfiguration=latestBuild/pdf-generator-deployment-configuration.json
