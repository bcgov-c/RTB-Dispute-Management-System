BuildTemplate=email-notification-build-configuration.yaml
DeploymentTemplate=email-notification-deploy-configuration.yaml

BuildConfiguration=latestBuild/email-notification-build-configuration.json
DeploymentConfiguration=latestBuild/email-notification-deployment-configuration.json
