...
namespace CM.Data.Model.Migrations
{
    ...
    [Migration("20220628180455_AddDeliveryDeadlineFields")]
    partial class AddDeliveryDeadlineFields
    {
            ...
            modelBuilder.Entity("CM.Data.Model.Notice", b =>
                {
                    ...
                    b.Property<int?>("DeliveryDeadlineDays")
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("FileId2")
                        .HasColumnType("integer");

                    b.Property<int?>("FileId3")
                        .HasColumnType("integer");

                    b.Property<int?>("FileId4")
                        .HasColumnType("integer");

                    b.Property<bool>("HasDeliveryDeadline")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("CM.Data.Model.Notice", b =>
                {
                    ...
                    b.HasOne("CM.Data.Model.File", null)
                        .WithMany("Notices1")
                        .HasForeignKey("FileId");
                    ...
                    b.HasOne("CM.Data.Model.File", null)
                        .WithMany("Notices3")
                        .HasForeignKey("FileId2");

                    b.HasOne("CM.Data.Model.File", null)
                        .WithMany("Notices4")
                        .HasForeignKey("FileId3");

                    b.HasOne("CM.Data.Model.File", null)
                        .WithMany("Notices5")
                        .HasForeignKey("FileId4");
