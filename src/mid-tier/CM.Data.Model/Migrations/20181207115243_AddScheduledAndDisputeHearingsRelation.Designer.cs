...
namespace CM.Data.Model.Migrations
{
    ...
    [Migration("20181207115243_AddScheduledAndDisputeHearingsRelation")]
    partial class AddScheduledAndDisputeHearingsRelation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CM.Data.Model.ConferenceBridge", b =>
                {
                    ...
                    b.Property<DateTime?>("PreferedEndTime");

                    b.Property<int?>("PreferedOwner");

                    b.Property<DateTime?>("PreferedStartTime");
            ...
            modelBuilder.Entity("CM.Data.Model.DisputeHearing", b =>
                {
                    ...
                    b.Property<int>("ScheduledHearingId");
            ...
            modelBuilder.Entity("CM.Data.Model.ScheduledHearing", b =>
                {
                    b.Property<int>("ScheduledHearingId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("CM.Data.Model.DisputeHearing", b =>
                {
                    ...
                    b.HasOne("CM.Data.Model.ScheduledHearing", "ScheduledHearing")
                        .WithMany("DisputeHearings")
                        .HasForeignKey("ScheduledHearingId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("CM.Data.Model.Hearing", b =>
                {
                    b.HasOne("CM.Data.Model.ConferenceBridge")
                        .WithMany("Hearings")
