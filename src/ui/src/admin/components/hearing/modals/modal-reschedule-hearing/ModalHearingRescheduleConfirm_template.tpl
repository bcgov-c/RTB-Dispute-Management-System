      ...
      <div class="">
        ...
        <div class="modalHearingRescheduleConfirm-current-hearing">
            <div class="">
              ...
              <div class="hearing-link-info"></div>
            </div>
            <div class="">
              <div class="hearing-owner-info"></div>
            </div>
        </div>
      </div>

      <div class="">
        <div class="review-applicant-title section-header">New hearing (being scheduled)</div>
        <div class="modalHearingRescheduleConfirm-new-hearing">
          <div class="">
            <div class="hearing-date-info"></div>
            <div class="hearing-link-info"></div>
          </div>
