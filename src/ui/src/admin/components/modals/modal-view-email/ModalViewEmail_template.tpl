  ...
  <div class="modal-content clearfix">
    ...
    <div class="modal-body">
      <div class="row">
        ...
        <div class="row email-no-bottom-padding-row">
          <div class="col-xs-12">
            <div id="email-notice-preview"></div>
            <div class="email-print-frame hidden"></div>
          </div>
        </div>

        <div class="row email-close-button-row">
          <div class="col-xs-12">
          <button type="button" class="btn-cancel btn btn-lg btn-default btn-standard btn-primary pull-right">Close</button>
          </div>
        </div>
    </div>
  </div>
