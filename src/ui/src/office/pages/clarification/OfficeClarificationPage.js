...
const requestName = 'clarification';
...
export default OfficeRequestPageView.extend({
  ...
  initialize() {
    const pageOptions = {
      ...
      taskActivityType: configChannel.request('get', 'TASK_ACTIVITY_TYPE_OS_CLARIFICATION'),
      requestType: configChannel.request('get', 'OUTCOME_DOC_REQUEST_TYPE_CLARIFICATION'),
      itemTypesConstantVals: [
        'OUTCOME_DOC_REQUEST_ITEM_TYPE_CLARIFICATION'
      ],
