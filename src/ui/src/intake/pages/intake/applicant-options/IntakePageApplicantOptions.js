...
export default PageView.extend({
  ...
  getPageApiUpdates() {
    ...
    // Create or update the fee here as well
    if (!paymentsChannel.request('get:fee:intake')) {
      all_xhr.push( _.bind(paymentsChannel.request, paymentsChannel, 'create:fee:intake') );
    }
